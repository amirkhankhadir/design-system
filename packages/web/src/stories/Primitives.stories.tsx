...
function PageSubtitle({ children }: { children: React.ReactNode }) {
  return (
    <p
      ...
      style={{ color: 'var(--ds-color-text-secondary)', margin: '0 0 8px' }}
    >
      {children}
    </p>
  );
...
function Warning({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      ...
      <p className="ds-text-small-1" style={{ color: 'var(--ds-color-text-primary)', margin: 0 }}>
        {children}
      </p>
    </div>
  );
...
export const All: Story = {
  ...
  render: () => (
    <div style={{ fontFamily: 'var(--ds-font-family-primary, sans-serif)', maxWidth: 900 }}>
      ...
      <Warning>
        Primitives are raw values only. Never reference them directly in components — always use
        semantic tokens (<code>--ds-color-*</code>) instead.
      </Warning>
      ...
      <Scale
        name="success"
        swatches={[
          { label: '0', value: '#03140d' },
          { label: '5', value: '#0b442b' },
          { label: '10', value: '#137149' },
          { label: '20', value: '#1e9863' },
          { label: '30', value: '#2db77b' },
          { label: '40', value: '#47d094' },
          { label: '50', value: '#68e3ad' },
          { label: '60', value: '#92f0c7' },
          { label: '70', value: '#c2f9e1' },
          { label: '80', value: '#dbfcee' },
      ...
      <Scale
        name="warning"
        swatches={[
          { label: '0', value: '#140c00' },
          { label: '5', value: '#462900' },
          { label: '10', value: '#774400' },
          { label: '20', value: '#a25e03' },
          { label: '30', value: '#c8760b' },
          { label: '40', value: '#e68e19' },
          { label: '50', value: '#ffa530' },
          { label: '60', value: '#ffbc5b' },
          { label: '70', value: '#ffd28d' },
          { label: '80', value: '#ffe8c2' },
      ...
      <Scale
        name="danger"
        swatches={[
          { label: '0', value: '#1f0400' },
          { label: '5', value: '#530a00' },
          { label: '10', value: '#851203' },
          { label: '20', value: '#b21f0d' },
          { label: '30', value: '#d6331f' },
          { label: '40', value: '#e94e3a' },
          { label: '50', value: '#f77160' },
          { label: '60', value: '#ff9b8f' },
          { label: '70', value: '#ffccc5' },
          { label: '80', value: '#ffe2de' },
      ...
      <Scale
        name="blue"
        swatches={[
          { label: '0', value: '#0a1628' },
          { label: '5', value: '#0d2244' },
          { label: '10', value: '#172e65' },
          { label: '20', value: '#2c57ba' },
          { label: '30', value: '#2060d0' },
          { label: '40', value: '#376be5' },
          { label: '50', value: '#497cf6' },
          { label: '60', value: '#86a8f9' },
          { label: '70', value: '#a4bdfb' },
          { label: '80', value: '#c2d3fc' },
          { label: '90', value: '#ecf1fe' },
          { label: '95', value: '#f6f8ff' },
        ]}
      />
      <Scale
        name="indigo"
        swatches={[
          { label: '10', value: '#1c1554' },
          { label: '40', value: '#4737cc' },
          { label: '50', value: '#5c4af5' },
          { label: '60', value: '#8d80f8' },
          { label: '70', value: '#aaa0fa' },
          { label: '80', value: '#c6c0fc' },
      ...
      <Scale
        name="purple"
        swatches={[
          { label: '10', value: '#2a135c' },
          { label: '40', value: '#6f39e5' },
          { label: '50', value: '#8754f6' },
          { label: '60', value: '#af8df9' },
          { label: '70', value: '#c3a9fb' },
          { label: '80', value: '#d7c6fc' },
      ...
      <Scale
        name="pink"
        swatches={[
          { label: '10', value: '#3f1436' },
          { label: '40', value: '#9e3186' },
          { label: '50', value: '#be3ba1' },
          { label: '60', value: '#d67ac2' },
          { label: '70', value: '#e09bd1' },
          { label: '80', value: '#eabde0' },
      ...
      <Scale
        name="rose"
        swatches={[
          { label: '10', value: '#3f131f' },
          { label: '40', value: '#9e2f4e' },
          { label: '50', value: '#be385e' },
          { label: '60', value: '#d77792' },
          { label: '70', value: '#e199ad' },
          { label: '80', value: '#ebbbc9' },
      ...
      <Scale
        name="cyan"
        swatches={[
          { label: '10', value: '#13344d' },
          { label: '40', value: '#2871a8' },
          { label: '50', value: '#4c92c7' },
          { label: '60', value: '#89bbe1' },
          { label: '70', value: '#a6cce9' },
          { label: '80', value: '#c4ddf0' },
      ...
      <Scale
        name="mint"
        swatches={[
          { label: '10', value: '#17331d' },
          { label: '40', value: '#316f3f' },
          { label: '50', value: '#3b854b' },
          { label: '60', value: '#6cbe7e' },
          { label: '70', value: '#91ce9e' },
          { label: '80', value: '#cef5d5' },
      ...
      <Scale
        name="lime"
        swatches={[
          { label: '10', value: '#2c3912' },
          { label: '40', value: '#5c7a22' },
          { label: '50', value: '#83aa36' },
          { label: '60', value: '#b0d16e' },
          { label: '70', value: '#c4dd92' },
          { label: '80', value: '#daebbc' },
      ...
      <Scale
        name="yellow"
        swatches={[
          { label: '10', value: '#332b10' },
          { label: '40', value: '#876b0e' },
          { label: '50', value: '#b88e07' },
          { label: '60', value: '#f7ce45' },
          { label: '70', value: '#fbdc76' },
          { label: '80', value: '#fce9ac' },
      ...
      />
      <Scale name="overlay / scrim" swatches={[{ label: '40%', value: 'rgba(0,0,0,0.40)' }]} />
    </div>
  ),
};
