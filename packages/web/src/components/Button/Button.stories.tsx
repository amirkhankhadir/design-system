...
export const Danger: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
      <Button variant="primary" danger iconLeft="delete">Delete</Button>
      <Button variant="secondary" danger iconLeft="delete">Delete</Button>
      <Button variant="tertiary" danger>Delete</Button>
...
export const Loading: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
      <p className="ds-text-small-1" style={{ color: 'var(--ds-color-text-secondary)', margin: 0 }}>
        Button dimensions are preserved during loading state
      </p>
      <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
        <Button variant="primary" size="sm" loading>Save</Button>
        <Button variant="primary" size="md" loading>Save changes</Button>
        <Button variant="primary" size="lg" loading iconLeft="save">Save changes</Button>
      </div>
      <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
...
export const Focus: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, alignItems: 'flex-start' }}>
      <p className="ds-text-small-1" style={{ color: 'var(--ds-color-text-secondary)', margin: 0 }}>
        Tab through buttons to see the focus ring — visible on all variants and backgrounds
      </p>
      ...
      <div style={{ display: 'flex', gap: 12, padding: 16, background: 'var(--ds-color-brand-subtle)', borderRadius: 'var(--ds-radius-8)' }}>
        <Button variant="primary">On brand bg</Button>
        <Button variant="secondary">On brand bg</Button>
      </div>
      <div style={{ display: 'flex', gap: 12, padding: 16, background: '#161616', borderRadius: 'var(--ds-radius-8)' }}>
        <Button variant="primary">On dark bg</Button>
        <Button variant="secondary">On dark bg</Button>
      </div>
    </div>
  ),
};
