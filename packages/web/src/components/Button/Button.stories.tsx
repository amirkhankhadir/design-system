  ...
  return (
    <div style={{ display: 'contents' }}>
      <p
        ...
        style={{ color: 'var(--ds-color-text-tertiary)', margin: 0, alignSelf: 'center' }}
      >
        {label}
      </p>
      {children}
...
export const Sizes: Story = {
  render: () => (
    <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
      <Button variant="primary" size="sm" iconLeft="add">
        Small
      </Button>
      <Button variant="primary" size="md" iconLeft="add">
        Medium
      </Button>
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: 'flex-start' }}>
      <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
        ...
        <Button variant="primary" iconRight="arrow_forward">
          Right icon
        </Button>
        <Button variant="primary" iconLeft="download" iconRight="arrow_forward">
          Both icons
        </Button>
      </div>
      <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
        ...
        <Button variant="link" iconRight="open_in_new">
          Open link
        </Button>
      </div>
    </div>
